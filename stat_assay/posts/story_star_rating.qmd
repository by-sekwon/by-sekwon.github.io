...
IMDb 공식이 하는 일은 결국 평범한 평균과 사전 기대값을 리뷰 수 비율로 섞는 **가중평균**이다. 강의노트 [〈기초통계 2. 데이터와 통계 — 측정형 데이터〉](../../notes/intro_stat/data.qmd#측정형-데이터)에는 가중평균의 일반식과 성적 계산·소비자물가지수 같은 다른 활용 사례도 함께 정리되어 있다.
:::
