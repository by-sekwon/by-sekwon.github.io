...
산술평균이 이상값에 흔들릴 때 쓸 수 있는 대안은 중앙값 말고도 여러 가지다. 강의노트 [〈기초통계 2. 데이터와 통계 — 측정형 데이터〉](../../notes/intro_stat/data.qmd#측정형-데이터)에서는 절사평균, 윈저화평균, 기하평균, 조화평균 등 상황별 대표값과 분산·표준편차 같은 산포도까지 함께 정리한다.
:::
...
- [데이터의 허와 실, 평균의 함정과 심슨의 역설 — 뷰저블](https://www.beusable.net/blog/?p=3298)
:::
