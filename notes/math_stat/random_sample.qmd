...
### <span style="color:green">chapter 1. 데이터와 확률표본</span>

#### <span style="color:blue">1. 데이터</span>
...
#### <span style="color:blue">2. 데이터 수집 및 모형</span>
...
#### <span style="color:blue">3. 데이터와 모집단</span>
...
### <span style="color:green">chapter 2. 확률표본 개념</span>

#### <span style="color:blue">1. 확률표본 정의 및 활용</span>
...
![](images/모집단 통계량.png){fig-align="center" width="40%"}
...
#### <span style="color:blue">2. 복원추출과 비복원추출</span>
...
### <span style="color:green">chapter 3. 확률표본의 함수</span>
...
#### <span style="color:blue">1. 통계량</span>
...
#### <span style="color:blue">2. 평균과 분산</span>
...
#### <span style="color:blue">3. 샘플링 분포</span>
...
### <span style="color:green">chapter 4. 정규분포로부터의 확률표본</span>
...
#### <span style="color:blue">1. 표본평균과 표본분산의 샘플링 분포</span>

**【정리】** 확률표본 $X_{1},\ldots,X_{n}$이 $\mathcal{N}(\mu,\sigma^{2})$분포에서
추출되었다고 하자. 표본평균
$\overline{X} = \frac{1}{n}\overset{n}{\sum_{i = 1}}X_{i}$, 표본분산
$S^{2} = \frac{1}{n - 1}\overset{n}{\sum_{i = 1}}(X_{i} - \overline{X})^{2}$에 대하여 다음이 성립한다.
...
#### <span style="color:blue">2. 카이제곱 확률변수에 대한 성질</span>
...
#### <span style="color:blue">3. 정규 변수들의 선형결합 간의 독립성 판별</span>
...
#### <span style="color:blue">4. 정규분포로부터 유도된 분포</span>
...
### <span style="color:green">chapter 5. 순서통계량</span>
...
#### <span style="color:blue">1. 순서통계량 정의</span>
...
#### <span style="color:blue">2. 순서 통계량 결합, 주변 확률밀도함수</span>
...
#### <span style="color:blue">3. 상자수염그림</span>
...
### <span style="color:green">chapter 6. 수렴개념</span>

#### <span style="color:blue">1. 확률수렴</span>
...
#### <span style="color:blue">2. 거의 확실한 수렴 ALL sure convergence</span>
...
#### <span style="color:blue">3. 분포 수렴 convergence in distribution</span>
...
### <span style="color:green">chapter 7. 확률표본 생성 : 시뮬레이션</span>
...
#### <span style="color:blue">2. 난수생성 방법</span>
...
2. 반복 $fort = 1,2,\ldots,N$: $\begin{matrix}
