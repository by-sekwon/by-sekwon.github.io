...
### <span style="color:green">chapter 1. 일반화 선형모형</span>

#### <span style="color:blue"> 1. 일반화 선형모형 개념</span>
...
#### <span style="color:blue"> 2. 왜 OLS를 사용할 수 없나?</span>
...
#### <span style="color:blue"> 3. 연결 LINK 함수</span> 
...
#### <span style="color:blue"> 4. 일반화 선형모형 추정</span>
...
### <span style="color:green">chapter 2. 이진형 종속변수 : 로지스틱 회귀</span>
...
#### <span style="color:blue"> 2. 링크함수 $g(\pi_{i}) = Xb$ </span>
...
#### <span style="color:blue"> 3. 오즈비</span>
...
#### <span style="color:blue"> 4. 추정</span>
...
### <span style="color:green">chapter 3. 로지스틱 회귀 사례분석</span>

#### <span style="color:blue"> 1. 타니타닉 데이터</span>
...
#### <span style="color:blue"> 3. 모형 추정</span>
...
#### <span style="color:blue"> 4. 오즈비</span>
...
#### <span style="color:blue"> 5. 모형 정확도 Confusion 행렬 </span>
...
#### <span style="color:blue"> 6. ROC 커브 </span>
...
### <span style="color:green">chapter 4. 다중 로짓 회귀</span>
